...
import { AdditiveBlending, BufferGeometry, MathUtils, Points as ThreePoints, ShaderMaterial, Vector2 } from 'three';
...
const Experiment = () => {
    const meshRef = useRef<ThreePoints<BufferGeometry, ShaderMaterial>>(null);
